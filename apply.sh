export VP_HOME = /var/www/vocprez-demeter
export VP_THEME_HOME = /var/www/vocprez-demeter_skin
export SPARQL_ENDPOINT = http://defs-dev.opengis.net:8080/rdf4j-server/repositories/demeter
